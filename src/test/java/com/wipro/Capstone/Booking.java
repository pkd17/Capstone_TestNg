...
public class Booking {
    ...
    WebDriver driver;  // 🔹 Declare driver at class level so all methods can use it
    ...
    public void BookingDetails() throws InterruptedException {
        ...
        email.sendKeys("pdb120@nist.edu");
        Thread.sleep(1000);


        WebElement phone = driver.findElement(By.cssSelector("input[id=':r10:']"));
        phone.sendKeys("9556959930");
        Thread.sleep(1000);
        
        WebElement finalr=driver.findElement(By.xpath("//span[@class='bui-button__text js-button__text']"));
        finalr.click();
